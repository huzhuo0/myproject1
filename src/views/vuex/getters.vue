...
<template>
  <div style="background:#fff">
    <p>vuex中state的使用: 非模块 {{$store.getters.getNormalCount}} peopleModule模块 {{$store.getters['peopleModule/getPeoModuleCount']}} workModule模块 {{$store.getters['workModule/getWorkModuleCount1']}}</p>
    <div>
        <div>
